...
const projetosAndamento = [
  {
    ...
    descricao: 'Projeto para nomear como "Parque Taiobeiras" a nova área verde urbana localizada no antigo Aterro Sanitário da BR-040, promovendo lazer e qualidade de vida.',
  ...
  },
  {
    ...
    descricao: 'Institui a Carteira de Identificação para Pessoas com Fibromialgia, garantindo prioridade de atendimento em serviços públicos e privados em Belo Horizonte.',
  ...
  },
  {
    ...
    descricao: 'Propõe alterações na legislação que regula o uso da Represa da Pampulha, visando a preservação do patrimônio e o uso consciente pela população.',
  ...
  },
  {
    ...
    descricao: 'Dispõe sobre a exclusão de usuário munícipe no cadastro do SISREDE (SUS-BH) na cidade de Belo Horizonte.',
    imagem: 'https://placehold.co/400x200/ffc107/000000?text=Legislação+e+Direitos',
  ...
  },
  {
    ...
    descricao: 'Projeto para a criação de duas novas linhas de ônibus para atender aos bairros mais afastados.',
...
const projetosAprovados = [
 {
    ...
    descricao: 'Reconhece a Corrida de Rolimã como prática esportiva oficial na cidade de Belo Horizonte. Sancionada como Lei Nº 11.886/2025.',
  ...
  },
  {
    ...
    descricao: 'Altera a legislação municipal para instituir o "Dia dos Profissionais da Beleza" a ser comemorado em 18 de junho. Sancionada como Lei Nº 11.824/2025.',
  ...
  },
  {
    ...
    descricao: 'Dá o nome de Rua Montaltino à antiga Rua Quatro Mil e Cinco, localizada no Bairro Pindorama. Sancionada como Lei Nº 11.662/2024.',
...
function popularCarrossel(seletorSwiper, dados) {
  const swiperWrapper = document.querySelector(`${seletorSwiper} .swiper-wrapper`);
...
const swiperAndamento = new Swiper('.projetos-andamento-swiper', {
  ...
  pagination: { el: '.projetos-andamento-swiper .swiper-pagination', clickable: true },
  navigation: { nextEl: '.projetos-andamento-swiper .swiper-button-next', prevEl: '.projetos-andamento-swiper .swiper-button-prev' },
});
...
const swiperAprovados = new Swiper('.projetos-aprovados-swiper', {
  ...
  pagination: { el: '.projetos-aprovados-swiper .swiper-pagination', clickable: true },
  navigation: { nextEl: '.projetos-aprovados-swiper .swiper-button-next', prevEl: '.projetos-aprovados-swiper .swiper-button-prev' },
});