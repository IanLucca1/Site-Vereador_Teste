...
const NoticiasCamera = [
  {
    data: "Fev 04, 2026",
    titulo:
      "Comissão de Saúde avança em exames oftalmológicos nas escolas 👁️📚",
    text: "A Comissão de Saúde aprovou parecer favorável ao Programa Oftalmologia nas Escolas, garantindo exames preventivos gratuitos para alunos da rede pública. Como presidente da comissão, o vereador José Ferreira também cobrou explicações sobre atrasos nos repasses aos hospitais filantrópicos do SUS-BH.",
...

  {
    ...
    text: "O vereador José Ferreira foi o parlamentar que mais aprovou visitas técnicas em 2025, com 260 requerimentos. As ações incluíram fiscalizações em centros de saúde, unidades especializadas e hospitais, motivadas por demandas da população, com identificação de falta de medicamentos, profissionais, insumos e falhas no atendimento.",
  ...
  },
  {
    data: "Dez 10, 2025",
    titulo:
      "Qualificação da Atenção Primária por meio de PPP em debate nesta quarta (3)",
  ...
  },
  {
    data: "Dez 02, 2025",
    titulo:
      "José Ferreira solicita audiência para debater melhorias na Atenção Primária via PPP",
